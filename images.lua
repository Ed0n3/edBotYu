...
duel_enemy_controller_region = Region(58, 436, 422, 88)
duel_riryoku_region = Region(58, 434, 211, 97)
duel_summon_flip_region = Region(457, 1313, 172, 163)
duel_vorse_raider_region = Region(52, 431, 343, 97)
duel_change_turn_battle_region = Region(727, 1211, 232, 121)
duel_change_turn_battle_to_end_region = Region(727, 1214, 235, 127)
duel_change_turn_end_region = Region(745, 854, 298, 125)
duel_change_turn_region = Region(883, 1145, 207, 136)
blue_dragon_summoner_region = Region(55, 431, 577, 100)
duel_main_phase_region = Region(163, 830, 340, 100)
duel_activate_effect_graveyard_dialog_yes_region = Region(526, 995, 489, 175)
duel_blue_eyes_white_dragon_region = Region(58, 428, 577, 102)
...
--evaluating regions
atk_region = Region(567, 547, 135, 62)
def_region = Region(867, 553, 128, 48)
cardName_region = Region(69, 448, 323, 57)
